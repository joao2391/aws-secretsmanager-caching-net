...
namespace Amazon.SecretsManager.Extensions.Caching
{
    ...
    public interface ISecretsManagerCache : IDisposable
    {
        ...
        /// </summary>
        Task<byte[]> GetSecretBinary(string secretId, CancellationToken cancellationToken);

        /// <summary>
        /// Asynchronously retrieves the specified SecretString after calling <see cref="GetCachedSecret"/>.
        /// </summary>
        Task<string> GetSecretString(string secretId, CancellationToken cancellationToken);
        ...
        /// </summary>
        Task<bool> RefreshNowAsync(string secretId, CancellationToken cancellationToken);
    }
}