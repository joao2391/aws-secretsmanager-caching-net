...
namespace Amazon.SecretsManager.Extensions.Caching
{
    ...
    class SecretCacheVersion : SecretCacheObject<GetSecretValueResponse>
    {
        ...
        /// </summary>
        protected override async Task<GetSecretValueResponse> ExecuteRefreshAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        protected override Task<GetSecretValueResponse> GetSecretValueAsync(GetSecretValueResponse result, CancellationToken cancellationToken = default(CancellationToken))
        {
