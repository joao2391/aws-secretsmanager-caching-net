...
namespace Amazon.SecretsManager.Extensions.Caching
{
    ...
    public class SecretCacheItem : SecretCacheObject<DescribeSecretResponse>
    {
        ...
        /// </summary>
        protected override async Task<DescribeSecretResponse> ExecuteRefreshAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// </summary>
        protected override async Task<GetSecretValueResponse> GetSecretValueAsync(DescribeSecretResponse result, CancellationToken cancellationToken = default(CancellationToken))
        {
